...
#ifndef DIJKSTRA_PLANNER_DEMO_H
#define DIJKSTRA_PLANNER_DEMO_H
...
private:
  ...
  // ROS
  ros::Timer publish_timer_{ nh_priv_.createTimer(ros::Duration(1.0), &DijkstraPlannerDemo::publish, this, false,
                                                  false) };

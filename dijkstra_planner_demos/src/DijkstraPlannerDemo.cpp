...
DijkstraPlannerDemo::DijkstraPlannerDemo()
{
...
void DijkstraPlannerDemo::publish(const ros::TimerEvent& event)
{
  // Visualize cost map
...
void DijkstraPlannerDemo::search()
{
  ...
  {
    ROS_WARN("%-65s %s\n", "Invalid search. Please check the map.", "[ DijkstraPlannerDemo]");
  }
